...
searchTwitter("paso2021", n=100) #con este codigo buscamos 100 tweets random de las ultimas semanas con la palabra "PASO 2021"



searchTwitter('paso2021', since='2021-07-19', until='2021-07-23') #repetimos la busqueda entre dos fechas (buscamos la ultima semana)
...
## una alternativa, usando resultType para ver tweets populares sobre un tema
